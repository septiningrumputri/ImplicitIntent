package com.septiningrum_202102248.implicitintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void  tampilWifi(View view){
        Intent kontakIntent = new Intent(Settings.ACTION_WIFI_SETTINGS);
        startActivity(kontakIntent);
    }
    ...
    public void  tampilDrive(View view){
        Intent driveIntent = new Intent(Intent.CATEGORY_LAUNCHER);
